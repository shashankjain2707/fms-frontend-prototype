  ...
  "default": [
    ...
    },
    {
      ...
      latestDocument: {
        ...
        documentType: "Quality Standards",
        version: "v2.1",
    ...
    },
    {
      ...
      latestDocument: {
        ...
        documentType: "Procurement Request",
        version: "v1.0",
        uploadDate: "2025-01-21",
        uploader: "Nidhi Shah",
        approvalStatus: "pending",
                          ...
                          <div className="bg-blue-50 rounded-lg p-3">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mt-2 text-sm text-gray-600">
                                  <div>
                                  ...
                                  <div>
                                    <span className="font-medium">Type:</span> {stage.latestDocument.documentType}
                                  </div>
                                  <div>
                                    <span className="font-medium">Format:</span> {stage.latestDocument.fileType}
                                  </div>
                                  <div>
